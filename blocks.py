...
import os
from world_blocks import Deathblock, Chest, Tool
...
BLOCKS['BlueOrtensia.png'] = Block(40, 40, 'BlueOrtensia.png',
...
BLOCKS['Pickaxe1'] = Tool(40, 40, 'Pickaxe1', 'Iron_Hammer', "assets/textures/items/iron_hammer.png")
#######################################################################################################################
