...
if __name__ == '__main__':
    ...
    deco_back = LitLayer("DecoBack", parallax=1.0, ambient_color=(80, 80, 130), realized_parallax=0.66)
    ...
    level.ambience = "assets/sounds/ambient_crickets1.wav"
    ...
    player.add_animation('jump_right',
                         load_horizontal_spritesheet("assets/animations/Aury/aury_jumping.png", 64, 64, row=0, scale=(1.2, 1.2)), stops=True, speed=8)
    player.add_animation('jump_left',
                         load_horizontal_spritesheet("assets/animations/Aury/aury_jumping.png", 64, 64, row=0, scale=(1.2, 1.2), flipx=True), stops=True, speed=8)
